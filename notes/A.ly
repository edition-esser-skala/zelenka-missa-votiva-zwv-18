...
KyrieIAltoNotes = {
  \relative c' {
    ...
    R1*7 %63
    d4 fis fis r
    fis8. fis16 fis8 fis fis fis r fis\pE %65
...
GratiasAltoNotes = {
  \relative c' {
    ...
    \tempoGratias fis4 fis8. fis16 fis4 g4~
    g g8 g ais4 ais8 ais
    h2. ais4
    fis fis8 e d[ fis] h4~ %200
    h h8 h h4_( ais8[ gis])
    ais2 r\fermata
    \tempoDomineDeus R1
    \mvTr h8.\pE^\solo h16 a!4 h8 cis16([ d)] cis8 h
    a16([ gis?)] fis8 r4 r a8 gis16 gis %205
    fis8[ gis16 ais] h4. a8 gis4
    fis8^\critnote r \mvTr fis\fE^\tutti fis16 fis gis8 eis fis fis
...
CumSanctoAltoNotes = {
  \relative c' {
    ...
    a a g4~ g2
    \mvTrr fis4\fermata^\markup \remark "Finis" r r a~
    a g fis g8[ a]
    h[ h, cis d] e4. fis8
    g4.( fis8) e4 a( %550
    g a8[ fis]) d4 r
...
CredoAltoNotes = {
  \relative c' {
    ...
    h8 a gis([ h)] a a a4~
    a h8 a16([ gis)] fis2
    \mvTrr gis4\fermata^\markup \remark "Finis" r r2
    R1*2 %90
    r2 a~
    a a~
    a a~
...
EtIncarnatusAltoNotes = {
  \relative c' {
    ...
    e[ c' h a] g4~
    g8[^\markup \remark "ad libitum" a] fis4. e8
    e4 r r
    R2.*10 %243
