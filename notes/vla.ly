...
KyrieIViola = {
  \relative c' {
    ...
    ais cis r d, cis fis r \mvTr fis\pE %65
    ais cis r d cis fis, r dis
    \mvTr g\fE a h c fis,4 r8 h
    ...
    e,4 r r2\fermata \bar "||" %110 finis
  }
}
...
ChristeViola = {
  \relative c' {
    ...
    d d d d-! r r\fermata \bar "||" %219 finis
  }
}
...
GratiasViola = {
  \relative c' {
    ...
    fis,16\fE gis32 a h cis dis? eis? fis8 fis16 fis eis8 cis fis fis
...
QuiTollisViola = {
  \relative c' {
    ...
    h4\f d g
    d r8 g g4\p
    \tempoQuiTollisCadenza as-\markup \remarkE "ad libitum" r g
    \tempoATempoE g4 c-! c-!
    es, c' c %355
    f, c' c
    as8. f16 g4 g,
...
QuoniamViola = {
  \relative c' {
    ...
    d8 fis g a d,4-! r\fermata \bar "||" %479 finis
  }
}
...
CumSanctoViola = {
  \relative c' {
    ...
    r2 \mvTr h-!\f-\markup \remark "sempre staccato" h-! r d d %480
    r g g r fis fis
    r h, h r c c
    r e e r a e
    r cis cis r fis fis
    ...
    \mvTrr a,8\fermata^\markup \remark "Finis" \tempoCumSanctoe fis' fis fis g g a a
    ...
    <g, d' h'> r r2\fermata \bar "|." %591 FINIS
  }
}
...
CredoViola = {
  \relative c' {
    ...
    h8 h' g e a g fis e
    d^\critnote e fis g a4 d
    a a, d16-\markup \remark "staccato" d' cis h a g fis e %65
    ...
    e e d cis h a gis fis e8-\markup \remark "staccato" a'16 cis gis h fis a
    ...
    \mvTrr gis16\fermata^\markup \remark "Finis" e dis cis h a gis fis e e'' dis cis h a gis fis
    e e dis cis h a gis fis e8 gis' gis gis
    h h h h a a a h %90
    h^\critnote h h h cis16 a gis fis e d cis h
    \mvTrr a8-\markup \remark "sempre staccato" a'16 fis a e a d, a cis a' fis a e a d,
...
EtIncarnatusViola = {
  \relative c' {
    ...
    fis dis e %240
    e8( fis) fis4.\trill e8
    \mvTrr e4\fermata^\markup \remark "Finis" \tempoEtIncarnatusFinis g fis
    e2.
    dis2 r4\fermata \bar "||" %244 finis
  }
}
...
BenedictusViola = {
  \relative c' {
    ...
    \key e \major \time 4/4 \tempoBenedictus
      \set Staff.timeSignatureFraction = 2/2
      \override Staff.TimeSignature.style = #'single-digit
    \mvTr gis'8\fE-\markup \remark "con sordino" fis e h'~ h cis h h
...
AgnusDeiViola = {
  \relative c' {
    ...
    h fis r fis e a r a %30
    a, a' r g f d r a'
    g e r g a a, r cis'
    a d r h e, a r e
    e, e' r gis e h' r h
    fis c r fis, h fis r fis %35
    g g, r c' h h, r h'
    fis cis r h h' h, r a'
    g h r a g h r fis
    e h' r e, g e r c
