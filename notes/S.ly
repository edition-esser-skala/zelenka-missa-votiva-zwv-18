...
KyrieISopranoNotes = {
  \relative c' {
    \clef treble
    \key e \minor \time 4/4 \autoBeamOff \tempoKyrieI
    R1*20 %20
    ...
    R1*7 %63
    fis4 h ais r
    cis8. cis16 d8 d cis cis r d\pE %65
...
ChristeSopranoNotes = {
  \relative c' {
    ...
    r e d c h a
    g[( h]) e8.^\markup \remark "ad libitum" g,16 fis8.[ e16]
    e4  r8 r4 r8
    R2. %180
    \mvTrr r8\fermata^\markup \remarkE "Finis" h' h e16([ d)] e8 r
    ...
    h16[^\markup \remark "ad libitum" a] a8.([ g16)] g4 r8
    R2.*9 %218
    R2.\fermata \bar "||" %219 finis
  }
}
...
QuiTollisSopranoNotes = {
  \relative c' {
    ...
    d~
    d4. c8 b4 %310
    a8([ g)] \mvTr fis4.\trill(^\markup \remark "ad libitum" g8)
    \mvTrr g4^\fermata^\markup \remark "Finis" r r
    R2.*2
    r4 r d' %315
    h4. a8 h4
    c8([ h)] c4 es
    ...
    d( g) d
    h( d) c~
    c8^\markup \remark "ad libitum" a! h4.( c8)
    c4 r r
    R2.*6 %360
    R2.\fermata \bar "||" %361 finis
  }
}
...
CumSanctoSopranoNotes = {
  \relative c' {
    ...
    \key g \major \time 6/2 \autoBeamOff \tempoCumSancto
      ...
      h2~ \tempoCumSanctod h
      \mvTrr a8\fermata^\markup \remark "Finis" fis fis fis g g a a
...
CredoSopranoNotes = {
  \relative c' {
    ...
    e4 e8 d cis2
    dis8 dis e2( dis4)
    \mvTrr e\fermata^\markup \remark "Finis" r r2
    R1*2 %91
    r2 a,~
    a a~
    a a~
