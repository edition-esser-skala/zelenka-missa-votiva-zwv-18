...
KyrieIViolinoI = {
  \relative c' {
    ...
    g8 d b g d'4.-\trill-\sostenuto d'8
    es4 d cis c
    h b a8-! d,-! d' c
    ...
    cis8 fis, fis h ais4 r16 \mvTr h,\pE cis d %65
    cis8 fis, fis h ais cis fis4~
    fis8 \mvTr h,\fE e4 dis r16 e fis g
...
ChristeViolinoI = {
  \relative c' {
    ...
    fis a' e a cis, a' fis( e) d( cis) h( a) %140
    h g8 h d16 g fis e d cis h
    a fis8 a d16 fis e d cis h a
    ...
    gis16.( a32) a16.([\trill gis64 a)] h8~ h16 e, a8[ gis]
    \mvDl <a, e' c' a'>\f^\tutti q q q q q
    ...
    \mvTrr e,4\fermata^\markup \remark "Finis" r8 r4 r8
    r4 r8 \mvTr fis'16\f-\vv h, ais( h) ais( h)
    h,4 r8 r g'\pE fis
    e e' d \appoggiatura d cis4 r8
    r4 r8 \mvDl <h, fis' d' h'>\f^\tutti q q %185
    ...
    \mvDl <g, d' h' g'>8\f r r <a e' c' a'> r r
    ...
    g16.[ \once \override TextSpanner.bound-details.left.text = \markup \remark "Ob. in 8va" h,32]\startTextSpan c8 d16.[(\trill c64 d)] e16. c32 a8[ d]
    g,\stopTextSpan \noBeam <g d' h' g'> <d' a' fis'> <g, d' h' g'>-! r r\fermata \bar "||" %219 finis
  }
}
...
GratiasViolinoI = {
  \relative c' {
    ...
    cis32 fis, gis a h cis dis? eis? fis16 cis fis a gis cis, gis' cis, a' cis, a' cis,
    ...
    fis16 fis32 g a16 fis fis fis32 g a16 fis g g a a h h cis cis
...
QuiTollisViolinoI = {
  \relative c' {
    ...
    r4^\markup \remark "sostenuto sempre" r \mvTr g'\pE-\tuttiE %233
    c2.~
    c4 h8( c) d4 %235
    ...
    es8 f d4.\trill c8
    \tuplet 3/2 4 { c,8(-\vv h' c) c,( h' c) c,( h' c)
    ...
    f f b, %275
    c d4.\trill es8
    \tuplet 3/2 4 { \mvTr es,8(\f-\vv d' es) es,( d' es) es,( d' es)
    ...
    \tempoQuiTollisCadenza es8-\markup \remarkE "ad libitum" f d4.\trill c8
    \tempoATempoE \tuplet 3/2 4 { \mvTr c,8(\f-\vv h' c) c,( h' c) c,( h' c)
...
QuoniamViolinoI = {
  \relative c' {
    ...
    d8 d' g, a d,4-! r\fermata \bar "||" %479 finis
  }
}
...
CumSanctoViolinoI = {
  \relative c' {
    ...
    r2 \mvTr fis'-!\f-\markup \remark "sempre staccato" fis-! r g-! g-!
    r d d r d d
    r d d r e e
    r e e r e e
    r e e r d d
    ...
    \time 4/4 \unset Staff.timeSignatureFraction \tempoCumSanctoc
      r8 g,\fE^\markup \remark "staccato sempre" g g a8. a16 a8 h
    ...
    << { \oneVoice \mvTrr a4\fermata^\markup \remark "Finis" } \\
    ...
    <g h, d, g,>-! r r2\fermata \bar "|." %591 FINIS
  }
}
...
CredoViolinoI = {
  \relative c' {
    ...
    a4 r r8 a'^\markup \remark "staccato" gis fis
    ...
    h8 h' g e' cis a d e
    fis e d e cis4 d~
    d cis d16-\markup \remark "staccato" d' cis h a g fis e %65
    ...
    fis16( e d8) a' h gis16 fis e8 r4
    r16 e d cis h a gis fis e^\markup \remark "staccato" e' cis e h e a, e'
    ...
    \mvTrr <e, h' e>4\fermata^\markup \remark "Finis" r r16 e' dis cis h a gis fis
    e4\trill r e'16( gis) h4 e,8
    d gis4 d8 cis16( e) fis4 a,8 %90
    gis16 e gis h gis e h' e cis a gis fis e d cis h
    \mvTrr a-\markup \remark "sempre staccato" a'' fis a e a d, a' cis, a' fis a e a d, a'
...
EtIncarnatusViolinoI = {
  \relative c' {
    ...
    R2.*3 %130
    h8(\pE^\markup \remark "sostenuto e con sordino" e) e( g) g( h,)
    c( a) a( fis') fis( a,)
    gis( h) h( e) e( gis,)
    a( e') e( a) a( e)
    ais( e) e( g) ais( h) %135
    ...
    g8 cis, dis4.\trill e8
    << { \mvTrr e2\fermata^\markup \remark "Finis" } \\ { s4 \tempoEtIncarnatusFinis s } >> \once \tieDashed h'4~
    h8 c ais4. h8
...
CrucifixusViolinoI = {
  \relative c' {
    ...
    c4\pp h8 a h2\fermata \bar "||" %307 finis
  }
}
...
EtResurrexitViolinoI = {
  \relative c' {
    ...
    \mvDl a''16-!\fE e,-! fis-! gis a h cis d e a, cis e %308
    ...
    fis'16 gis fis e d d, d d fis' d, d d
...
SanctusViolinoI = {
  \relative c' {
    ...
    g4 fis8 e fis2\fermata \bar "|." %27 FINIS
  }
}
...
BenedictusViolinoI = {
  \relative c' {
    ...
    \key e \major \time 4/4 \tempoBenedictus
      \set Staff.timeSignatureFraction = 2/2
      \override Staff.TimeSignature.style = #'single-digit
    \mvTr h''4.\fE-\markup \remark "con sordino" gis16 fis e dis \appoggiatura dis e8 r16 e gis a
