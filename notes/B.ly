...
GratiasBassoNotes = {
  \relative c {
    ...
    r4 \mvDl e'8\fE^\tuttiE e16 e dis8 h e e
...
QuoniamBassoNotes = {
  \relative c {
    ...
    fis d r4 r d'~
    d^\markup \remark "ad libitum" g, a2
    d,4 r r2
    R1*4 %478
    R1\fermata \bar "||" %479 finis
  }
}
...
CumSanctoBassoNotes = {
  \relative c {
    ...
    g[ fis e d] cis2
    \mvTrr d8\fermata^\markup \remark "Finis" d d d e8. e16 fis8 fis
...
CredoBassoNotes = {
  \relative c {
    ...
    h([ a gis a] h2)
    \mvTrr e,4\fermata^\markup \remark "Finis" r r2
    R1
    R %90
    r2 a~
    a a~
...
EtResurrexitBassoNotes = {
  \relative c {
    ...
    r4 e'8 d cis h
    a[ gis a h cis dis]
    \appoggiatura dis4 \afterGrace e2 { e8[ dis e] } e,4\fermata
    R2. %490
    r4 a\mfE g
    f2\pE e4
    dis2.\ppE
...
DonaNobisBassoNotes = {
  \relative c {
    ...
    c8 g a[ h] c r r h\pE
    c r r h\f c[ g a h]
    e,4 r r2\fermata \bar "|." %150 FINIS
  }
}
