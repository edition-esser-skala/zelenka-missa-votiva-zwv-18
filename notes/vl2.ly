...
ChristeViolinoII = {
  \relative c' {
    ...
    \mvDl <a, e' c' a'>8\f-\tutti q q q q q
...
QuiTollisViolinoII = {
  \relative c' {
    ...
    g'4\pE -\tweak TextScript.X-offset #2 -\tuttiE ^\markup \remark "sostenuto sempre" g f %233
    es g g
    g g g %235
    g g g
    as as a
    ...
    d,4 r8 d'-! c4~ %250
    c8 d h4.\trill c8
    \tuplet 3/2 4 { c,(-\vv h' c) c,( h' c) c,( h' c)
    ...
    d f, g %275
    f f b
    \tuplet 3/2 4 { \mvTr b8(\f-\vv d es) es,( d' es) es,( d' es)
    g,( d' es) g,( d' es) g,( d' es)
    as,( d es) g,( d' es) es,( d' es) }
    c8. as16 f4 f %280
    es \mvTr g\p-\vv g-\tenuto
    f f d
    es es b'
    c4. b8 a? g
    f4 r r %285
    ...
    es8. c16 d4 d %315
    \mvTrr d8^\fermata^\markup \remark "Finis" (-. \mvTr d-.\p-\vv d-. d-. d-. d-.)
    es-.( es-. es-. es-. es-. es-.)
    f(-. as-. as-. g-. f-. f-.)
    f c' c c d c
    ...
    g,(\f h d g d c h d h) }
    g4 r8 d' c4~\p
    \tempoQuiTollisCadenza c-\markup \remarkE "ad libitum" c h8.\trill c16
...
CredoViolinoII = {
  \relative c' {
    ...
    d d, a'4 r8 e' fis d
    e a, a' g? fis16-\markup \remark "staccato" d' cis h a g fis e %65
    d4 r a2~
    a a~
    a a~
    a fis~
