...
KyrieIBassiOrgano = {
	\relative c {
		...
		es' d c b c4 d
		g8 d b?-\critnote g d'4.-\sostenuto d'8
		es4 d cis c
		h b a8 d, d' c
		h4 r8 g c4 r8 a %40
		...
		fis' e d h fis' e d \mvTr h\pE-\critnote %65
		fis' e d h fis' e dis h
		\mvTr e\fE-\critnote fis g a h a g e
		h' a g e h' a g e\p
		h' a g e h' cis dis h\f
		e4 d c h %70
		a g fis h
...
ChristeBassiOrgano = {
	\relative c {
		...
		a fis! ais h, h' a?
		g e gis a dis, h'
		e, d c16^\markup { \anmerkung "ad libitum" } h a8 h h'
		e, e'\f d c h a
		g a h e,16. c'32 a8[ h] %180
		\mvTrr e,\fermata^\markup { \anmerkung Finis } e,\p d' cis cis' h
		ais fis ais h cis d
		g, g, fis' e e' d
		cis cis, h' ais fis h
		g e fis h,\f h' a %185
		...
		g8 fis e d c h
		h' a g fis g g,
		c^\markup { \anmerkung "ad libitum" } d4 g8\f g, r
		fis' a d g,\p g, r %210
		fis' a d r d,\f r
		d r d r c' h
		e c d g,, g' fis
		...
		g, h d g-! r r \bar "||" %219 finis
	}
}

ChristeZiffern = \figuremode {
	r4. <6 4>8 <5 3>4 %111
...
GloriaBassiOrgano = {
	\relative c {
		...
		<< {
			...
			a16_\markup { \anmerkung "Fagotti e Violoni" } a, a a a a a a a a a a
...
GloriaZiffern = \figuremode {
	...
	<5 3>4 <\t \t> <[5+] _+>
	<5 3>8 q <[6\\] 5 [_+]>4. \bassFigureExtendersOn <6\\ 5 _+>8 \bassFigureExtendersOff
	<7 _+>4 <[6\\] _+> <_+>
	<5>4. <7>8 <_+>4
	r8 <6> r <7> r <_+> %75
	<6>4. <7>8 <_+>4
...
GratiasBassiOrgano = {
	\relative c {
		...
		\mvTr fis,16\fE-\tutti gis32 a h cis? d e fis8 fis eis cis fis fis
		...
		h8 g c c h g \mvTr c\pE-\markup {  \override #'(baseline-skip . 2) \column { \line { \anmerkung "senza Organo," } \line { \anmerkung "Fagotti e Bassi" } } } c16 c %225
		h8 g c c h g \mvTr c\fE-\markup {\anmerkung "Org." } c16 c
		h8 g c c h g r4
		c8 h a g f e d g
...
GratiasZiffern = \figuremode {
	r2. <6 [4!]>4 %173
	<6 [4!] 2>2 <7 [4!] 2>4. \bassFigureExtendersOn <7 4! 2>8 \bassFigureExtendersOff
	r2 <5 4>4 <\t 3> %175
	...
	<8 3>4. \bassFigureExtendersOn q8 \bassFigureExtendersOff <5+ [4]>4 <\t [_+]>
...
QuiTollisBassiOrgano = {
	\relative c {
		...
		c2^\tenuto r4
		c4\pE fis, g %310
		c, d-\markup { \anmerkungE "ad libitum" } d,
		g\f g' g
		b, g' g
		c, g' g
		es8. c16 d4 d, %315
		\mvTrr g'\fermata^\markup { \anmerkung Finis } g\p f
		es d c
		f f, r
		f' r fis
		g g, r %320
		...
		f2\f r4
		f4 h, c\pE
		f-\markup { \anmerkungE "ad libitum" } g g,
		c c'-! c-!
		es,^\tenuto c'-! c-! %355
		f,^\tenuto c'-! c-!
		as8. f16 g4 g
...
QuoniamBassiOrgano = {
	\relative c {
		...
		e fis gis e \mvTr a,\f-\markup { \anmerkung Rip. } h cis h
		a h\pE cis a d e fis d
		\mvTr g,\f-\markup { \anmerkung Rip. } a h a g h\pE c? d
		...
		g2^\markup { \anmerkung "ad libitum" } a
		d,8\fE d d d d d d d
		d d d d d d d d %475
		g g g g r g cis,4
		r8 d r a' r h\p g g,
		r g'\f cis,4 r8 d r a'
		d fis, g a d,4-! r \bar "||" %479 finis
	}
}

QuoniamZiffern = \figuremode {
	r1 %384
	r4. <6>8 r2 %385
	r1
	r2 <5 3>8 <6>4.
...
CumSanctoBassiOrgano = {
	\relative c {
		...
		\mvTrr d8\fermata^\markup { \anmerkung Finis } \tempoCumSanctoe d[ d d] e8.^\critnote e16 fis8 fis
...
CumSanctoAkkorde = {
	\key g \major \time 3/2 \tempoCumSancto
	<< \relative c' {
...
CredoBassiOrgano = {
	\relative c {
		...
		a4 r r8 a'-\tutti^\markup { \anmerkung staccato } gis fis
		...
		h4. h8 h, \noBeam \mvTr h'\pE-\markup { \anmerkung "Solo à 3" } a a,
		...
		\clef "treble_8" r8 d'-\markup { \anmerkung "Solo à 3" } cis h a d cis h
		a d cis h a h cis d
		...
		h a gis a h4 h,
		\mvTrr e16\fermata^\markup { \anmerkung Finis } e'-\solo dis cis h a gis fis e e e e e e e e
...
EtIncarnatusBassiOrgano = {
	\relative c {
		...
		\mvTr e4\pE-\soloE e,^\markup { \anmerkung "sempre piano" } a' %128
		h a g
		fis h h, %130
		e r e
		dis r dis
		...
		h g h %230
		c dis, e
		a^\markup { \anmerkung "ad libitum" } h2
		e,4 r dis
		d r cis
		c r h %235
		c a h
		...
		dis h e %240
		a, h h,
		\mvTrr e,\fermata^\markup { \anmerkung Finis } \tempoEtIncarnatusFinis e' d
		c2.
		h2 r4 \bar "||" %244 finis
	}
}

EtIncarnatusZiffern = \figuremode {
	r2 <6>4 %128
	<_+> <\t> <6>
	<5+> <_+> r %130
	r2.
...
EtResurrexitBassiOrgano = {
	\relative c {
		...
		gis4 fis e
		a h h,
		\mvTr e\fE-\markup { \anmerkung Rip. } dis cis %460
		h a gis
		cis8. h16 a4 h
		e \mvTr e,\p-\solo d'
		cis cis' h
		...
		r fis\fE r cis d e
		\mvTr a,16\ffE-\markup { \anmerkung "Tutti registri" } a' gis a a a gis a a a gis a
		a, a' gis a a a gis a a a gis a
		fis8. cis16 d4 e-!
		a,-! r r \bar "|." %590 FINIS
	}
...
EtResurrexitZiffern = \figuremode {
	...
	<[6]> <[6\\]> r
	r <[_+]>2
	<[8] [3]>2 \bassFigureExtendersOn <8 3>4 %460
	...
	<_+>2.
	r %490
	<5 [_!]>2 \bassFigureExtendersOn <5 _!>8 q \bassFigureExtendersOff
	<[5!] 3>2 \bassFigureExtendersOn <5! 3>8 q \bassFigureExtendersOff
	<[7!] 5>2 \bassFigureExtendersOn <7! 5>8 q \bassFigureExtendersOff
	<5 4>4 <\t 3>2
	r2 <1>4 %495
	q q2
	r2.
...
SanctusZiffern = \figuremode {
	...
	<5+ [_+]>4. \bassFigureExtendersOn <5+ _+>8 <[6\\] 4\+ 2>4. <6\\ 4\+ 2>8 \bassFigureExtendersOff
	<6>4 <5> <6>8 <\t> <5 3> <\t \t>
	...
	<7 [_+]>2 <4>4 <_+>
	<5> <6\\>8 <6> <6 [_+]> <[5+] _+> <[6] [4]>8 <[7] [_+]>
	<5>4 <[6\\]>8 <[5]> <9 5+ _+>4 <8>8 <[7]>
	<5>4 <[6\\] 5> <7 [5+] _+>2
	<5+ 4>4 <\t _+> r <5> %25
	<6> <_+> r2
...
BenedictusBassiOrgano = {
	\relative c {
		...
		\key e \major \time 4/4 \tempoBenedictus
			\set Staff.timeSignatureFraction = 2/2
			\override Staff.TimeSignature.style = #'single-digit
		e8_\soloE^\markup { \anmerkung "sempre pianissimo" } fis gis e16 fis gis8 a gis e16 fis
...
BenedictusZiffern = \figuremode {
	...
	<[5\!] [3\!]>4. <5 3>8 \bassFigureExtendersOff <7>4. q8
	<6 4> <5 _+>4. <5 3>4. \bassFigureExtendersOn q8
	<[5\!] [3\!]>4. <5 3>8 \bassFigureExtendersOff <7>4. q8 %35
	<6 4> <[4] [2+]> <6> <[7] _+> r4 <[6]>8 <_+>8
	r2 <6 5>4. <_+>8
	<[6]>4 q8 <_+> r4. q8
	r4 <6> q q
	q <[6]> <_+>4. <[6]>8 %40
...
OsannaBassiOrgano = {
	\relative c {
		...
		a4 d a r8 a-\markup { \anmerkung "senza Bassi Ripieni" } %95
		f e d f e4 a
		e2-\markup { \anmerkung "Rip." } f4. f8
		e4 a d, e
		f2 e4 r8 e
